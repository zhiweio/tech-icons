...
Run: uv run uvicorn src.web.app:app --reload --port 8765
"""
...
from src.formats import IconNotFoundError, format_icon
...
app = FastAPI(
    title="tech-icons",
    description="HTTP API for browsing 2200+ cloud tech icons",
    version="0.1.0",
    lifespan=lifespan,
)
...
def get_icon_svg(
    ...
    try:
        content = format_icon(icon_path, icon_id, fmt=format)
